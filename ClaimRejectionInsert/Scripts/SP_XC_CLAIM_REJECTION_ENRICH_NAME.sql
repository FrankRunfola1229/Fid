...
IF  OBJECT_ID('SP_XC_CLAIM_REJECTION_ENRICH_NAME') IS NOT NULL
	BEGIN
		DROP PROCEDURE SP_XC_CLAIM_REJECTION_ENRICH_NAME
   		PRINT '<< Procedure SP_XC_CLAIM_REJECTION_ENRICH_NAME Dropped >>'
   	END
ELSE 	
	PRINT '<< Procedure SP_XC_CLAIM_REJECTION_ENRICH_NAME DOES NOT EXIST >>'   	
GO

/*********************************************************************************
	NAME:			SP_XC_CLAIM_REJECTION_ENRICH_NAME							
	DESCRIPTION:    ENRICH EDI_XC_PROV_NAME_REJECTED_CLAIMS records for response 
                    file to clearing house
	DEVELOPER:      FRANK P. RUNFOLA
	DATE:			5/17/2019
*********************************************************************************/

CREATE PROC SP_XC_CLAIM_REJECTION_ENRICH_NAME
AS
...
IF  OBJECT_ID('SP_XC_CLAIM_REJECTION_ENRICH_NAME') IS NOT NULL
   	PRINT '<< Procedure [SP_XC_CLAIM_REJECTION_ENRICH_NAME] CREATED! >>'

GRANT EXECUTE ON APP_CONFIG..SP_XC_CLAIM_REJECTION_ENRICH_NAME TO Claims_Rejection_Role GO

/********************************************************
				EXAMPLE SP EXECUTE
********************************************************

EXECUTE  APP_CONFIG..SP_XC_CLAIM_REJECTION_ENRICH_NAME
